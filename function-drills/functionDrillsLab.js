...
let compareNums = (num1, num2) => {
  ...
  //     condition   ? expression for truthy : expression for falsey
...
//CODE HERE
  ...
  function harryPotter(budget){
    let frogsAfford = budget / 3
    return frogsAfford
  }

  let totalFrogs = harryPotter(268)
...
function harryPotter2(budget){
  let frogsAfford = budget / 3
  return Math.floor(frogsAfford)
}

let totalFrogs2 = harryPotter(268)
